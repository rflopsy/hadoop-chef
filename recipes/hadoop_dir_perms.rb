...
ensure_hadoop_owns_hadoop_dirs('/mnt/hadoop-hdfs/logs',           owners['hadoop']['uid'], "0775")
ensure_hadoop_owns_hadoop_dirs('/mnt/hadoop-0.20-mapreduce/logs', owners['mapred']['uid'], "0775")
